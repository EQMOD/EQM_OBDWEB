/**************************************************************************************************
  Filename:       TPMSBroadcast_Tester.h
...
#ifndef TPMSBroadcast_Tester_H
#define TPMSBroadcast_Tester_H
...
extern void TPMSBroadcast_Tester_Init( uint8 task_id );

/*
 * Task Event Processor for the BLE Broadcaster Application
 */
extern uint16 TPMSBroadcast_Tester_ProcessEvent( uint8 task_id, uint16 events );
